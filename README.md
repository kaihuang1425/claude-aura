...
- [ ] **P0** Style the installed Claude Desktop application through a
      consented, version-gated runtime connection, keeping the Aura web window
...
Those two are the P0 work, and the rest of the list is paused behind them. See
the [P0 styling paths brief](./docs/P0_STYLING_PATHS.md) for the execution
order, freeze list, and definition of done. Desktop styling ships only if its
feasibility and policy gates pass; until they do, Claude Desktop opens
unchanged and unthemed. Aura never patches Claude Desktop's files, packages, or
signatures on either outcome.
...
- [P0 styling paths brief](./docs/P0_STYLING_PATHS.md)
