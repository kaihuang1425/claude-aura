...
<p align="center">
  <img src="../docs/readme-showcase/actual-work-hub-tabs.png"
       alt="实际安装的 Claude Aura 仪表板，包含目标标签页和本地会话看板"
       width="900"><br>
  <sub>实际安装的 Aura 截图 · 仪表板、目标标签页和本地会话看板</sub>
</p>
...
仪表板 始终固定显示，用户打开的 Claude 页面位于同一标签栏。Studio 也会用
...
仪表板 将 Aura 观察到的会话分为**活动**、**已打开**和**过去**。点击卡片时，
Aura 会复用已经打开的标签页，或重新打开已知的规范地址。看板只保存本地路由和
状态元数据，不保存对话内容；最新请求的图标也不会把整个目标误报为已完成。

<p align="center">
  <img src="../docs/readme-showcase/actual-work-hub-tabs.png"
       alt="实际安装的 Claude Aura 仪表板 标签页和会话看板"
       width="900"><br>
  <sub>实际安装的 Aura 截图 · 仪表板</sub>
</p>
...
- **用真实标签页保留 Claude 工作。** 仪表板 固定显示；用户打开的页面继续使用各自的 WebView2 控件和本地标签元数据。
- **从 仪表板 继续。** 活动、已打开和过去的会话来自加密且不含正文的本地记录，只会重新打开已知的规范地址。
...
| **仪表板** | 显示不含正文的活动、已打开和过去会话卡片，并返回已知的 Aura 地址 |
