...
(() => {
  ...
  registry["en"] = {
    ...
    editor: {
      ...
      greetingPersonalEnable: "Use personalized greeting words",
      ...
      greetingNameHelp: "Used wherever a line contains {name}. Lines with {name} are skipped while this is empty.",
      ...
      editorActionTimedOut: "Aura did not answer. Your last change was kept and sent again.",
